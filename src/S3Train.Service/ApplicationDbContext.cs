...
namespace S3Train.Domain
{
        ...
        IdentityDbContext<ApplicationUser, ApplicationRole, string, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TaiLieuVanBan>().Property(p => p.Dang).HasMaxLength(50).IsOptional();
            ...
            modelBuilder.Entity<ChiTietMuonTra>().Property(p => p.TaiLieuVanBanId).IsOptional();
